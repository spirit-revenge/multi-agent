...
| 12 | 前端侧边栏不自动刷新 | 🟡 中 | ✅ 已修复 | — |
| 13 | 关闭联网搜索时 UI 仍显示"搜索网络"步骤 | 🟡 中 | ✅ 已修复 | — |
| 14 | 搜索结果点击无跳转 | 🟡 中 | ✅ 已修复 | — |
| 15 | 关闭联网搜索后答案仍含"图片来源：网络搜索" | 🟡 中 | ✅ 已修复 | — |
| 16 | SVG 架构图无法渲染 | 🟢 低 | ✅ 已修复 | — |
| 17 | `.env` 文件存在无用变量 | 🟢 低 | ✅ 已修复 | — |
